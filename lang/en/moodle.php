...
$string['recyclebin_help'] = 'If enabled, deleted activities will be sent to a recycle bin.';
$string['recyclebinttl'] = 'Recycle bin period';
$string['recyclebinttl_help'] = 'Defines how long items should remain in the recycle bin before they are permanently deleted.';
$string['recyclebinttlnever'] = 'Never delete recycled items';
$string['recyclebinempty'] = 'There are no items in the recycle bin.';
$string['recyclebinemptyconfirm'] = 'Are you sure you want to delete all items in the recycle bin?';
$string['recyclebindeleteconfirm'] = 'Are you sure you want to delete the selected item from the recycle bin?';
$string['recyclebinrestored'] = '{$a} has been restored';
$string['recyclebindeleted'] = '{$a} has been deleted';
