...
class manager {
    ...
    /**
     * Return the current adhoc task manager.
     */
    public static function get_adhoc_manager() {
        global $CFG;

        static $manager;

        if (!isset($manager)) {
            $class = isset($CFG->queue_manager) ? $CFG->queue_manager : '\\core\\task\\adhoc_manager_db';
            $manager = new $class();
        }
    ...
    protected static function task_is_scheduled($task) {
        debugging("\core\\task\\manager::task_is_scheduled is deprecated,
        use \\core\\task\\manager::get_adhoc_manager()->task_is_scheduled() instead.");

        return self::get_adhoc_manager()->task_is_scheduled($task);
    }
    ...
    public static function queue_adhoc_task(adhoc_task $task, $checkforexisting = false) {
        debugging("\core\\task\\manager::queue_adhoc_task is deprecated,
        use \\core\\task\\manager::get_adhoc_manager()->queue_adhoc_task() instead.");

        return self::get_adhoc_manager()->queue_adhoc_task($task, $checkforexisting);
    }
    ...
    public static function record_from_adhoc_task($task) {
        debugging("\core\\task\\manager::record_from_adhoc_task is deprecated,
        use \\core\\task\\adhoc_manager_db::record_from_adhoc_task instead.");

        return adhoc_manager_db::record_from_adhoc_task($task);
    }
    ...
    public static function adhoc_task_from_record($record) {
        debugging("\core\\task\\manager::adhoc_task_from_record is deprecated,
        use \\core\\task\\adhoc_manager_db::adhoc_task_from_record instead.");

        return adhoc_manager_db::adhoc_task_from_record($record);
    }
    ...
    public static function get_adhoc_tasks($classname) {
        debugging("\core\\task\\manager::get_adhoc_tasks() is deprecated,
        use \\core\\task\\manager::get_adhoc_manager()->get_adhoc_tasks() instead.");
        return self::get_adhoc_manager()->get_adhoc_tasks($classname);
    }
    ...
    public static function get_next_adhoc_task($timestart) {
        debugging("\core\\task\\manager::get_next_adhoc_task() is deprecated,
        use \\core\\task\\manager::get_adhoc_manager()->get_next_adhoc_task() instead.");
        return self::get_adhoc_manager()->get_next_adhoc_task($timestart);
    }
    ...
    public static function adhoc_task_failed(adhoc_task $task) {
        debugging("\core\\task\\manager::adhoc_task_failed() is deprecated,
        use \\core\\task\\manager::get_adhoc_manager()->adhoc_task_failed() instead.");
        return self::get_adhoc_manager()->adhoc_task_failed($task);
    }
    ...
    public static function adhoc_task_complete(adhoc_task $task) {
        debugging("\core\\task\\manager::adhoc_task_complete() is deprecated,
        use \\core\\task\\manager::get_adhoc_manager()->adhoc_task_complete() instead.");
        return self::get_adhoc_manager()->adhoc_task_complete($task);
    }
